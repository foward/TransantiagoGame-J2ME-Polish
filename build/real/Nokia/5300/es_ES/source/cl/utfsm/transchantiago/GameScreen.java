 ...
 * @author friveros
 */
import cl.utfsm.transchantiago.util.Sound;
...
private int timeGame=0;
  ...
  public GameScreen(MidletTrans midlet) throws Exception {
    ...
    Image peatonNormal = Image.createImage("/peatones.png");
    peatones = new Sprite(peatonNormal);
    peatones.setPosition(20, 20);
      	...
      	if (isShown()) {
            ...
            this.isMicroAcelerating = this.gameMap.getisAcelerate();
             //if user is pressing the left button
              if ((keyStates & LEFT_PRESSED) != 0) {
                    ...
                    } else if ((keyStates & UP_PRESSED) != 0 && !this.player.collidesWith(this.edificios, true)) {
            ...
            if ((keyStates & FIRE_PRESSED) != 0) {
              //TODO poner sonido bocina
            	...
            	//this.sonido.volume(this.midlet.datos.getVolumen()*10);
            	//this.sonido.play("bocina", "amr");
            }
...
/**
  ...
  private void render(Graphics g) {
   ...
   //peatones.paint(g);
    ...
    g.drawString("Vidas " + this.player.getLives(), 130, 0, Graphics.RIGHT | Graphics.TOP);
    g.drawString("$ " + this.player.getDineroRecollected(), 200, 0, Graphics.HCENTER | Graphics.TOP);
    flushGraphics();
