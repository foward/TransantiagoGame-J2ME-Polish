 ...
 */
public class HorizontalBackground extends Background
{
	 ...
	 * 
	 */
	public HorizontalBackground( Background leftBackground, Background rightBackground, int splitPos, int splitSide, int margin )
	{
