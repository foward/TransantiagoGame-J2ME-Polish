...
//# 			
		...
		//#if tmp.manualOrientationChange
			//#if polish.css.screen-orientation-change-animation
				//# this.screenOrientationAnimation = (ScreenChangeAnimation) style.getObjectProperty(313);
			//#endif
		//#endif
	}
...
//			g.fillRect( clipX, clipY, 10, 10 );
	...
	public void setTitle(Item item) {
		...
		if (item != null){
			//#ifdef polish.ScreenWidth:defined
int width = 176  - (this.marginLeft + this.marginRight);
			//#else
				//# int width = this.screenWidth - (this.marginLeft + this.marginRight);
			//#endif
			if (width > 1) {
...
menuText = "Cancel";
	...
	public void addSubCommand(Command child, Command parent) {
		//#style menuitem, menu, default
		addSubCommand( child, parent , de.enough.polish.ui.StyleSheet.menuStyle );
	}
