...
public class MidletTrans extends MIDlet {
  ...
  private static final String scoreRMSName = "TransSettings";
  ...
  protected void showErrorMsg(String alertMsg) {
    if (alertMsg == null || CONST_DEBUG == false) {
      alertMsg = "Error Inicializando Transchantiago, Contacte su proveedor mas cercano";
    }
    alert = new Alert("Transantiago ERROR",alertMsg,null,null);
